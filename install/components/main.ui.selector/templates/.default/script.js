;(function () {
    ...
    BX.Main.SelectorV2.prototype = {
        ...
        getData: function (callback) {
            ...
            BX.ajax.runComponentAction('kosmos:main.ui.selector', 'getData', {
                mode: 'ajax',
                data: {
        ...
        loadAll: function (params) {
            ...
            if (
                ...
                BX.ajax.runComponentAction('kosmos:main.ui.selector', 'loadAll', {
                    mode: 'ajax',
                    data: {
                        entityType: entity
                    }
        ...
        searchRequest: function (params) {
            ...
            BX.ajax.runComponentAction('kosmos:main.ui.selector', 'doSearch', {
                mode: 'ajax',
                data: {
        ...
        getTreeItemRelation: function (params) {
            BX.ajax.runComponentAction('kosmos:main.ui.selector', 'getTreeItemRelation', {
                mode: 'ajax',
                data: {
        ...
        saveDestination: function (params) {
            if (
                ...
                if (BX.type.isNotEmptyString(context)) {
                    BX.ajax.runComponentAction('kosmos:main.ui.selector', 'saveDestination', {
                        mode: 'ajax',
                        data: {
                            context: context,
                            itemId: params.itemId
